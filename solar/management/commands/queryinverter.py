...
class Command(BaseCommand):
    help = 'Query the inverter for latest data.'

    def handle(self, *args, **options):
        """
        Process the command line getting of inverter data.
        """

        solar_data = SolarData()
        solar_data.store()

        self.stdout.write(self.style.SUCCESS('Successfully processed data.'))
